...
public class UserLogin {
    ...
    public UserLogin(int loginId, String loginUserName, String userType, String emailId, String password,
                     Boolean updatedBy, Boolean loginAcess, String password1, String password2, String password3,
